...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, isFullscreen = false, onToggleFullscreen, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        isFullscreen ? "inset-0 !left-0 !top-0 !translate-x-0 !translate-y-0 !rounded-none !max-w-none !w-screen !h-screen" : "w-full max-w-lg sm:rounded-lg",
        className
      )}
      {...props}
    >
